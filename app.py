...
@app.route('/')
def home():
    return "নীরব রাতের বুকে চাঁদের আলো,স্বপ্নগুলো হাঁটে পায়ে পায়ে ধীরে।হাওয়ার সাথে কথা বলে স্মৃতিরা,হারানো দিনের গল্প ফিরে ফিরে ঘিরে।একাকী তারার চোখে জমে আশা,ভোরের রোদে মিলবে নতুন ঠিকানা।যত অন্ধকার থাকুক পথের বুকে,আলো আসবেই—এই তো জীবনের মানা।"
...
# --- Configuration ---
TOKEN = '8550862162:AAFevBqorMRcsRYfe5V2rt3yeDTDzLdATd0' # Replace with your actual token
OWNER_ID = 6499194100 # Replace with your Owner ID
ADMIN_ID = 6499194100 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@jubayer_ahmed_34' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/mr_ghost34' # Replace with your update channel link
...
def attempt_install_npm(module_name, user_folder, message):
    # npm সম্পূর্ণ disabled
    bot.reply_to(
        message,
        "⚠️ Node/npm সাপোর্ট বন্ধ আছে। শুধু Python (.py) ফাইল রান করা যাবে।"
    )
    return False
...
def run_js_script(script_path, script_owner_id, user_folder, file_name, message_obj_for_reply, attempt=1):
    # JS / Node / npm সম্পূর্ণ বন্ধ
    bot.reply_to(
        message_obj_for_reply,
        "❌ JavaScript (.js) সাপোর্ট বন্ধ আছে। শুধু Python (.py) ফাইল রান করা যাবে।"
    )
    return
...
def handle_zip_file(downloaded_file_content, file_name_zip, message):
    ...
    try:
        ...
        # package.json handling disabled (npm not supported)
        main_script_name = None; file_type = None
        preferred_py = ['main.py', 'bot.py', 'app.py']; preferred_js = ['index.js', 'main.js', 'nm.py', 'gh.py']
